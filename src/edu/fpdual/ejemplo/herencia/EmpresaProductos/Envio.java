...
public class Envio {
    ...
    public Envio (int id, String medio, Fresco[] frescos, Refrigerado[] refrigerados, AirFrozen[] congeladosAire, WaterFrozen[] congeladosAgua, NitrogenFrozen[] congeladosNitrogeno) {
        this.id = id;
        this.medio = medio;
